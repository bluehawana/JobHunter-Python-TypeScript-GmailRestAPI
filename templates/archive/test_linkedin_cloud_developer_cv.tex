...
{\Large Cloud Developer - Stockholm}}\\[10pt]
...
% JD Keywords: AWS, Azure, GCP, Docker, Kubernetes, Terraform, CloudFormation, Jenkins, GitLab CI, GitHub Actions
% Role: devops_cloud
