...
{\Large Senior DevOps Engineer}}\\[10pt]
...
% JD Keywords: Jenkins, GitLab CI, GitHub Actions, Kubernetes, Docker, Terraform, Ansible, AWS, Azure, Python
% Role: devops_cloud
