...
\definecolor{mylightblue}{RGB}{77, 166, 255}\moderncvcolor{mylightblue}
...
% Customized for: DevOps Engineer at Volvo Cars

\section{Professional Summary}
\cvitem{}{Experienced Software Developer with expertise in Python and backend systems. Strong background in automotive software development and proven track record in microservices architecture. Seeking to contribute technical skills to Volvo Cars's devops engineer role.}

\section{Technical Skills}
\cvitem{Languages}{\textbf{Python, JavaScript, TypeScript, SQL}}
\cvitem{Frameworks}{\textbf{Python, Docker, Kubernetes}}
\cvitem{Technologies}{\textbf{AWS}}
\cvitem{Databases}{PostgreSQL, MySQL, Redis, MongoDB}

\section{Work Experience}
\cventry{2021--Present}{ Software Developer}{TechCorp AB}{Stockholm, Sweden}{}{
\begin{itemize}
...
\cvitem{Docker}{Docker Certified Associate}
