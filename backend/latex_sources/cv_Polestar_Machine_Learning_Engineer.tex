...
% Customized for: Machine Learning Engineer at Polestar

\section{Professional Summary}
\cvitem{}{Experienced Software Developer with expertise in Python and backend systems. Strong background in automotive software development and proven track record in microservices architecture. Seeking to contribute technical skills to Polestar's machine learning engineer role.}

\section{Technical Skills}
\cvitem{Languages}{\textbf{Python, JavaScript, TypeScript, SQL}}
\cvitem{Frameworks}{\textbf{Python}}
