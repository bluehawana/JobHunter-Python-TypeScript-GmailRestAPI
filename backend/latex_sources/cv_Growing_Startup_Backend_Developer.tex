...
% Customized for: Backend Developer at Growing Startup

\section{Professional Summary}
\cvitem{}{Experienced Software Developer with expertise in Python and backend systems. Passionate about building scalable applications and proven track record in microservices architecture. Seeking to contribute technical skills to Growing Startup's backend developer role.}

\section{Technical Skills}
\cvitem{Languages}{\textbf{Python, JavaScript, TypeScript, SQL}}
\cvitem{Frameworks}{\textbf{Python, Django, PostgreSQL}}
\cvitem{Technologies}{\textbf{AWS, FastAPI}}
...
\item Thesis: Scalable Web Application Architecture
