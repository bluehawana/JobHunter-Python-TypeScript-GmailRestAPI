...
% Customized for: Senior Python Developer at TechCorp Sweden

\section{Professional Summary}
\cvitem{}{Experienced Software Developer with expertise in Python and backend systems. Passionate about building scalable applications and proven track record in microservices architecture. Seeking to contribute technical skills to TechCorp Sweden's senior python developer role.}

\section{Technical Skills}
\cvitem{Languages}{\textbf{Python, JavaScript, TypeScript, SQL}}
\cvitem{Frameworks}{\textbf{Python, FastAPI, PostgreSQL}}
