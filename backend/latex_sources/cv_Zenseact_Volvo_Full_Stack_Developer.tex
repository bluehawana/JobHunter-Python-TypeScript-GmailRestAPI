...
% Customized for: Full Stack Developer at Zenseact (Volvo)

\section{Professional Summary}
\cvitem{}{Experienced Software Developer with expertise in Python and backend systems. Strong background in automotive software development and proven track record in microservices architecture. Seeking to contribute technical skills to Zenseact (Volvo)'s full stack developer role.}

\section{Technical Skills}
\cvitem{Languages}{\textbf{Python, JavaScript, TypeScript, SQL}}
\cvitem{Frameworks}{\textbf{Python, FastAPI, React}}
\cvitem{Technologies}{\textbf{TypeScript}}
