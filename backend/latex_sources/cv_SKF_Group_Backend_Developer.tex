...
% Customized for: Backend Developer at SKF Group

\section{Professional Summary}
\cvitem{}{Experienced Software Developer with expertise in Python and backend systems. Passionate about building scalable applications and proven track record in microservices architecture. Seeking to contribute technical skills to SKF Group's backend developer role.}
...
\item Worked on IoT data processing and real-time analytics
