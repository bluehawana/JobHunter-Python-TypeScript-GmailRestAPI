...
% Customized for: Full Stack Developer at Digital Agency

\section{Professional Summary}
\cvitem{}{Experienced Software Developer with expertise in Python and backend systems. Passionate about building scalable applications and proven track record in microservices architecture. Seeking to contribute technical skills to Digital Agency's full stack developer role.}

\section{Technical Skills}
\cvitem{Languages}{\textbf{Python, JavaScript, TypeScript, SQL}}
\cvitem{Frameworks}{\textbf{Python, FastAPI, React}}
\cvitem{Technologies}{\textbf{TypeScript, PostgreSQL}}
