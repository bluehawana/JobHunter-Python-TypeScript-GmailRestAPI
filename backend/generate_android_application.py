...
def generate_android_cover_letter(company: str, position: str):
    ...
    latex_cl = rf"""\documentclass[11pt,a4paper]{{article}}
\usepackage{{geometry}}
\usepackage{{hyperref}}
\usepackage{{xcolor}}
...
I am particularly drawn to {company} because of the opportunity to contribute my unique combination of technical expertise and cross-cultural communication skills. In today's global tech landscape, the ability to bridge cultural and business-technical gaps is increasingly valuable. I am confident that my trilingual capabilities, technical skills, and proven track record of making things happen would make me an asset to your team.

I am eager to bring my Android development expertise, soft skills, and cultural bridge capabilities to {company}. I would welcome the opportunity to discuss how my background and skills align with your team's needs.
