#!/usr/bin/env python3
"""
Script to create database tables directly using PostgreSQL connection
"""
...
async def execute_sql_file(conn, file_path: str) -> bool:
...
async def setup_database():
    """Set up database tables using direct PostgreSQL connection"""
    print("🚀 JobHunter Database Direct Setup")
    print("=" * 60)
    ...
    try:
        ...
        if os.path.exists(schema_file):
            success = await execute_sql_file(conn, schema_file)
            if success:
