...
\textbf{Python, TypeScript, Gmail REST API, LinkedIn API}
\begin{itemize}[noitemsep]
\item Automated job hunting pipeline with backend API integration
\item Built RESTful APIs for application tracking and management
\end{itemize}
