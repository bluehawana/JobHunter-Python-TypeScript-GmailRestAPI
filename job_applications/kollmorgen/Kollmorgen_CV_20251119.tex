...
\item \textbf{Databases:} PostgreSQL, MySQL, MongoDB, SQLite, time-series data
\item \textbf{Cloud/DevOps:} AWS, Azure, Docker, Kubernetes, CI/CD, Grafana, Prometheus
\item \textbf{Data Visualization:} Grafana dashboards, Prometheus metrics, custom charts, geolocation
\item \textbf{Automotive:} Android Auto, AOSP, in-vehicle testing, Polestar platforms
\item \textbf{Testing:} Unit testing, integration testing, UI testing, automated frameworks
\end{itemize}
